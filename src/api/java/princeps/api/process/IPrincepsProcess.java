...
import princeps.api.event.events.PathEvent;

/**
 * A process that can control the PathingBehavior.
 * <p>
 * Differences between a princeps process and a behavior:
 * <ul>
 * <li>Only one princeps process can be active at a time</li>
 ...
 * @author leijurv
 */
public interface IPrincepsProcess {
    ...
    /**
     * Called when this process is in control of pathing; Returns what Princeps should do.
     *
