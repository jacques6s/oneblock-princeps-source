...
package princeps.api.command.helpers;
...
public class TabCompleteHelper {
    ...
    public TabCompleteHelper addSettings() {
        return append(
                PrincepsAPI.getSettings().allSettings.stream()
    ...
    public TabCompleteHelper addModifiedSettings() {
        return append(
                SettingsUtil.modifiedSettings(PrincepsAPI.getSettings()).stream()
                        .map(Settings.Setting::getName)
                        .sorted(String.CASE_INSENSITIVE_ORDER)
        );
    }
    ...
    public TabCompleteHelper addToggleableSettings() {
        return append(
                PrincepsAPI.getSettings().getAllValuesByType(Boolean.class).stream()
                        .map(Settings.Setting::getName)
                        .sorted(String.CASE_INSENSITIVE_ORDER)
        );
    }
