 ...
 * @since 11/12/2018
 */
public final class PrincepsPlayerContext implements IPlayerContext {

    private final Princeps princeps;
    private final Minecraft mc;
    private final IPlayerController playerController;

    public PrincepsPlayerContext(Princeps princeps, Minecraft mc) {
        this.princeps = princeps;
        this.mc = mc;
        this.playerController = new PrincepsPlayerController(mc);
    }
    ...
    public IWorldData worldData() {
        return this.princeps.getWorldProvider().getCurrentWorld();
    }
    ...
    public Rotation playerRotations() {
        return this.princeps.getLookBehavior().getEffectiveRotation().orElseGet(IPlayerContext.super::playerRotations);
    }
