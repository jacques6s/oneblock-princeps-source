...
import princeps.api.pathing.calc.IPathFinder;
...
public abstract class AbstractNodeCostSearch implements IPathFinder, Helper {
    ...
    /**
     * @see <a href="https://github.com/cabaletta/princeps/issues/107">Issue #107</a>
     */
    ...
    AbstractNodeCostSearch(BetterBlockPos realStart, int startX, int startY, int startZ, Goal goal, CalculationContext context) {
        ...
        this.map = new Long2ObjectOpenHashMap<>(Princeps.settings().pathingMapDefaultSize.value, Princeps.settings().pathingMapLoadFactor.value);
    }
