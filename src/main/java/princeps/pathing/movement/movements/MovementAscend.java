...
public class MovementAscend extends Movement {
    ...
    public MovementAscend(IPrinceps princeps, BetterBlockPos src, BetterBlockPos dest) {
        super(princeps, src, dest, new BetterBlockPos[]{dest, src.above(2), dest.above()}, dest.below());
    }
    ...
    public MovementState updateState(MovementState state) {
        ...
        state.setInput(Input.SNEAK, Princeps.settings().allowWalkOnMagmaBlocks.value && jumpingOnto.is(Blocks.MAGMA_BLOCK));
        ...
        if (Princeps.settings().assumeStep.value || ctx.playerFeet().equals(src.above())) {
