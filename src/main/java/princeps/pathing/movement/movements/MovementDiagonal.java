...
public class MovementDiagonal extends Movement {
    ...
    public MovementDiagonal(IPrinceps princeps, BetterBlockPos start, Direction dir1, Direction dir2, int dy) {
        this(princeps, start, start.relative(dir1), start.relative(dir2), dir2, dy);
        // super(start, start.offset(dir1).offset(dir2), new BlockPos[]{start.offset(dir1), start.offset(dir1).up(), start.offset(dir2), start.offset(dir2).up(), start.offset(dir1).offset(dir2), start.offset(dir1).offset(dir2).up()}, new BlockPos[]{start.offset(dir1).offset(dir2).down()});
    }

    private MovementDiagonal(IPrinceps princeps, BetterBlockPos start, BetterBlockPos dir1, BetterBlockPos dir2, Direction drr2, int dy) {
        this(princeps, start, dir1.relative(drr2).above(dy), dir1, dir2);
    }

    private MovementDiagonal(IPrinceps princeps, BetterBlockPos start, BetterBlockPos end, BetterBlockPos dir1, BetterBlockPos dir2) {
        super(princeps, start, end, new BetterBlockPos[]{dir1, dir1.above(), dir2, dir2.above(), end, end.above()});
    }
