...
package princeps.command.argument;
...
import princeps.api.command.datatypes.IDatatype;
import princeps.api.command.datatypes.IDatatypeContext;
import princeps.api.command.datatypes.IDatatypeFor;
import princeps.api.command.datatypes.IDatatypePost;
...
import princeps.api.command.exception.CommandTooManyArgumentsException;
...
public class ArgConsumer implements IArgConsumer {
    ...
    public <T, O, D extends IDatatypePost<T, O>> T getDatatypePost(D datatype, O original) throws CommandInvalidTypeException, CommandNotEnoughArgumentsException {
        try {
            ...
            if (Princeps.settings().verboseCommandExceptions.value) {
                e.printStackTrace();
            }
    ...
    private final class Context implements IDatatypeContext {
        ...
        public final IPrinceps getPrinceps() {
            return ArgConsumer.this.manager.getPrinceps();
        }
