...
public class ComeCommand extends Command {
    ...
    public ComeCommand(IPrinceps princeps) {
        super(princeps, "come");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        args.requireMax(0);
        princeps.getCustomGoalProcess().setGoalAndPath(new GoalBlock(ctx.viewerPos()));
        logDirect("Coming");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The come command tells Princeps to head towards your camera.",
                "",
