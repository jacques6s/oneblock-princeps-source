...
import princeps.api.pathing.goals.GoalAxis;
...
public class AxisCommand extends Command {
    ...
    public AxisCommand(IPrinceps princeps) {
        super(princeps, "axis", "highway");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The axis command sets a goal that tells Princeps to head towards the nearest axis. That is, X=0 or Z=0.",
                "",
                "Usage:",
                "> axis"
        );
