...
import princeps.api.pathing.goals.GoalInverted;
...
public class InvertCommand extends Command {
    ...
    public InvertCommand(IPrinceps princeps) {
        super(princeps, "invert");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The invert command tells Princeps to head away from the current goal rather than towards it.",
                "",
                "Usage:",
