...
public class SurfaceCommand extends Command {
    ...
    protected SurfaceCommand(IPrinceps princeps) {
        super(princeps, "surface", "top");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The surface/top command tells Princeps to head towards the closest surface-like area.",
                "",
