...
public class ProcCommand extends Command {
    ...
    public ProcCommand(IPrinceps princeps) {
        super(princeps, "proc");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The proc command provides miscellaneous information about the process currently controlling Princeps.",
                "",
                "You are not expected to understand this if you aren't familiar with how Princeps works.",
                "",
                "Usage:",
