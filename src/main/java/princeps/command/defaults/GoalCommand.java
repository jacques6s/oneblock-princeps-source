...
public class GoalCommand extends Command {
    ...
    public GoalCommand(IPrinceps princeps) {
        super(princeps, "goal");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        ICustomGoalProcess goalProcess = princeps.getCustomGoalProcess();
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The goal command allows you to set or clear Princeps's goal.",
                "",
