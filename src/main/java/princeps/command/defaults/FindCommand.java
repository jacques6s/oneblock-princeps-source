...
import princeps.api.command.datatypes.BlockById;
...
public class FindCommand extends Command {
    ...
    public FindCommand(IPrinceps princeps) {
        super(princeps, "find");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The find command searches through Princeps's cache and attempts to find the location of the block.",
