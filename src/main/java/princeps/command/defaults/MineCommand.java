...
public class MineCommand extends Command {
    ...
    public MineCommand(IPrinceps princeps) {
        super(princeps, "mine");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        princeps.getMineProcess().mine(quantity, boms.toArray(new BlockOptionalMeta[0]));
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The mine command allows you to tell Princeps to search for and mine individual blocks.",
                "",
