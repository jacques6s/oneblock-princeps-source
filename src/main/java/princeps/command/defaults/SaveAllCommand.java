...
public class SaveAllCommand extends Command {
    ...
    public SaveAllCommand(IPrinceps princeps) {
        super(princeps, "saveall");
    }
    ...
    public String getShortDesc() {
        return "Saves Princeps's cache for this world";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The saveall command saves Princeps's world cache.",
                "",
                "Usage:",
                "> saveall"
        );
